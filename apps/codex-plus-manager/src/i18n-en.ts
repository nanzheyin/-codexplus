...
export const EN_PLAIN: Record<string, string> = {
  ...
  "已停止": "Stopped",
  "已登录（未测试）": "Signed in (not tested)",
  "已配置（未测试）": "Configured (not tested)",
  "未登录": "Not signed in",
  "由 Codex 自动选择": "Selected automatically by Codex",
  "无可测地址": "No measurable URL",
  "重新检测服务可达延迟": "Recheck service reachability latency",
  "此供应商没有可测的服务地址": "This provider has no measurable service URL",
  "API Key": "API Key",
  ...
  "系统浏览器未能打开 OAuth 登录页，请检查默认浏览器后重试。": "The system browser could not open the OAuth sign-in page. Check your default browser and try again.",
  "等待浏览器授权完成": "Waiting for browser authorization",
  "暂时无法查询 OAuth 登录状态，正在重试。": "OAuth sign-in status is temporarily unavailable. Retrying.",
  "无法查询 OAuth 登录状态，请重新点击浏览器登录。": "Could not check OAuth sign-in status. Click Browser sign-in to try again.",
  ...
  "检测并恢复历史会话": "Detect and restore history",
  "旧会话与侧边栏索引已检查": "Historical sessions and sidebar indexes checked",
  "恢复旧会话并合并重复来源": "Restore historical sessions and merge duplicate sources",
  "开始检测与恢复": "Detect and restore",
  "检测并恢复": "Detect and restore",
  "正在检测与恢复…": "Detecting and restoring…",
  "历史会话恢复未完成，请根据提示重试。": "Session recovery did not complete. Follow the message and retry.",
  "，重启 Codex 后侧边栏会重新载入": ", restart Codex to reload the sidebar",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "已同步到 {0}：修复 {1} 个会话文件，恢复 {2} 条侧边栏索引，更新 {3} 行数据库，合并 {4} 条重复来源{5}{6}{7}。":
    "Synced to {0}: repaired {1} session file(s), restored {2} sidebar index row(s), updated {3} database row(s), and merged {4} duplicate source row(s){5}{6}{7}.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^历史会话恢复完成：修复 (\d+) 个会话文件，恢复 (\d+) 条侧边栏索引，更新 (\d+) 行数据库，合并 (\d+) 条重复来源。$/, "Session recovery complete: repaired $1 session file(s), restored $2 sidebar index row(s), updated $3 database row(s), and merged $4 duplicate source row(s)."],
  [/^历史会话恢复未完成：(.+)$/, "Session recovery did not complete: $1"],
