...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Codex 日志数据库上限": "Codex log database limit",
  "Debug 端口": "Debug port",
  ...
  "会话删除、导出、项目移动和页面增强能力": "Session deletion, export, project move and page enhancement capabilities",
  ...
  "更多": "More",
  "MCP、Skills 与 Plugins": "MCP, Skills & Plugins",
  ...
  "更多功能": "More features",
  "识别 Codex 应用": "Locate the Codex app",
  "选择本机 Codex.exe、Codex.app 或应用目录":
    "Select Codex.exe, Codex.app, or the app directory on this computer",
  "配置供应商": "Configure a provider",
  "完成官方登录，或填写 API Base URL、Key 与模型":
    "Complete official login, or enter the API Base URL, key, and models",
  "安装并启动": "Install and launch",
  "安装 Codex Deck 入口后启动 Codex": "Install the Codex Deck entrypoint, then launch Codex",
  "完成首次配置": "Complete initial setup",
  "按顺序完成三步，即可稳定启动和切换 Codex":
    "Complete these three steps in order to launch and switch Codex reliably",
  "0 表示关闭；超限时会在 Codex 退出后删除最旧日志并压缩数据库，不阻塞下次启动，也不影响会话、消息和 rollout。":
    "0 disables the limit. When exceeded, the oldest logs are deleted and the database is compacted after Codex exits, without blocking the next launch or affecting sessions, messages, or rollouts.",
  "未启用": "Not enabled",
  "尚未执行日志数据库维护。": "Log database maintenance has not run yet.",
  "立即维护": "Maintain now",
  ...
  "工具、增强、维护、设置与诊断": "Tools, enhancements, maintenance, settings, and diagnostics",
};
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "已检索：{0}；当前上限：{1}": "Detected: {0}; current limit: {1}",
