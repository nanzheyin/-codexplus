...
export const EN_PLAIN: Record<string, string> = {
  ...
  "适合官方登录或官方混入 API Key；保留会话删除、导出和项目移动，关闭插件市场相关增强。":
    "Suited to official login or official mixed-in API Key; keeps session deletion, export and project move while disabling plugin-marketplace-related enhancements.",
